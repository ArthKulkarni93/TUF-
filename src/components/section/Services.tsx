        ...
        <div className="w-full h-screen justify-end px-4 md:px-10 bg-black mb-20">
            ...
            >
                ...
                <div className="relative h-90 md:h-96 w-70 md:w-72 flex-shrink-0 ml-16 md:ml-20 hover:-translate-y-8 transition-transform duration-300 z-20">
                    <img className="h-full w-full object-cover rounded-lg" src="https://res.cloudinary.com/dh626d9by/image/upload/v1751728709/DSA1_mmxh1m.png" alt="Core Subject" />
                ...
                <div className="relative h-90 md:h-96 w-70 md:w-72 flex-shrink-0 hover:-translate-y-8 transition-transform duration-300 z-20">
                    <img className="h-full w-full object-cover rounded-lg" src="https://res.cloudinary.com/dh626d9by/image/upload/v1751728723/core_kyaeol.png" alt="DSA" />
                ...
                <div className="relative h-90 md:h-96 w-70 md:w-72 flex-shrink-0 hover:-translate-y-8 transition-transform duration-300 z-20">
                    <img className="h-full w-full object-cover rounded-lg" src="https://res.cloudinary.com/dh626d9by/image/upload/v1751728685/premium1_jjz5ib.png" alt="Core Subject 2" />
                ...
                <div className="relative h-90 md:h-96 w-70 md:w-72 flex-shrink-0 hover:-translate-y-8 transition-transform duration-300 z-20">
                    <img className="h-full w-full object-cover rounded-lg" src="https://res.cloudinary.com/dh626d9by/image/upload/v1751728709/DSA1_mmxh1m.png" alt="DSA 2" />
                ...
                <div className="relative h-90 md:h-96 w-70 md:w-72 flex-shrink-0 opacity-80 -mr-10 md:-mr-20 hover:-translate-y-8 transition-transform duration-300 z-20">
                    <img className="h-full w-full object-cover rounded-lg" src="https://res.cloudinary.com/dh626d9by/image/upload/v1751728723/core_kyaeol.png" alt="Core Subject 3" />
