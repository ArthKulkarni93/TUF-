        ...
        <div className="w-full h-screen  justify-end px-4 md:px-10 bg-black mb-20">
            ...
            <div>
                <div className="text-white text-2xl w-[300px] ml-7 mt-24 sm:w-[350px] sm:text-3xl md:text-4xl sm:ml-20 md:w-[400px] md:mt-24 lg:text-5xl lg:w-[500px] xl:text-6xl xl:w-[650px]   leading-tight tracking-tight">
                    <span className="">Empowering developers</span>
            ...
            <div
                className="flex mt-7 gap-6 md:gap-10 overflow-x-auto scrollbar-hide pr-8 md:pr-20 relative"
                style={{ maxWidth: '100vw', overflowY: 'visible', overflowX: 'auto', paddingTop: '2rem', paddingBottom: '2rem' }}
            >
                ...
                <div className="relative h-90 md:h-96 w-70 md:w-72 flex-shrink-0 ml-16 md:ml-20 hover:-translate-y-8 transition-transform duration-300 z-20">
                    <img
                        ...
                        src="src/assets/DSA.png"
                        alt="Core Subject"
                    />
                    <span className="absolute p-6  inset-0 flex  text-white text-18 leading-tight tracking-tight drop-shadow-lg">
                        Data Structures & Algo
                    </span>
                    <span className="absolute hidden md:block inset-y-14 inset-x-6 flex text-[#a3a5ae] text-15 tracking-tight leading-snug justify-text drop-shadow-lg">
                ...
                {/* 5th image slightly visible by negative right margin */}
            ...
            <div className="text-white ml-7  gap-y-4 2xl:mt-10 grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 sm:w-[500px] lg:w-[900px] lg:gap-x-22  sm:ml-20 md:gap-x-38 leading-tight tracking-tight">
                <div>
                    <span className="text-2xl sm:text-3xl text-4xl ">90 million</span>
                    <br />
                    <span className="text-md text-[#a3a5ae]">Monthly downloads</span>
                </div>

                <div>
                    <span className="text-2xl sm:text-3xl text-4xl ">33.3k</span>
                    <br />
                    <span className="text-md text-[#a3a5ae]">GitHub Stars</span>
                </div>

                <div>
                    <span className="text-2xl sm:text-3xl text-4xl ">4.7k</span>
                    <br />
                    <span className="text-md text-[#a3a5ae]">Discord members</span>
                </div>

                 <div>
                    <span className="text-2xl sm:text-3xl text-4xl ">2.5k</span>
                    <br />
